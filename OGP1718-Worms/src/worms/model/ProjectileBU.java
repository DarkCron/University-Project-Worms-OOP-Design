...
public class ProjectileBU extends GameObject {
	
	public enum Projectile_Type{
		RIFLE, BAZOOKA;
	}

	public ProjectileBU(Location location,Direction direction, Radius radius, World world)
...
//	boolean isTerminated = false;
	...
	private static CreateProjectile RIFLE = (worm) -> {
		...
		ProjectileBU bullet = new ProjectileBU(projectileLocation,projectileDirection , projectileRadius, worm.getWorld());
			...
			for (Object worm : this.getWorld().getAllObjectsOfType(Worm.class)) {
				if(worm instanceof Worm) {
					...
					//	((Worm) worm).overlapsWith(new Circle(new Location(jumpStep(i)),this.getRadius()));
						//TODO((Worm) worm).hitByProjectile(this);
